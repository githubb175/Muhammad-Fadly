			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="fakultas" class="form-control" required>
						...
						<option value="INSTITUTE TEKNOLOGI BANDUNG" <?php if($data['fakultas'] == 'INSTITUTE TEKNOLOGI BANDUNG'){ echo 'selected'; } ?>>INSTITUTE TEKNOLOGI BANDUNG</option>
						<option value="ITENAS" <?php if($data['fakultas'] == 'ITENAS'){ echo 'selected'; } ?>>ITENAS</option>
						<option value="UNPAD" <?php if($data['fakultas'] == 'UNPAD'){ echo 'selected'; } ?>>UNPAD</option>
					</select>
				</div>
			</div>
			<div class="form-group row">
